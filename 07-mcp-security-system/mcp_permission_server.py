"""Permission-Aware MCP Server — risk-tiered tools with audit logging.

Tools span four risk levels (read LOW, write MEDIUM, delete HIGH,
execute CRITICAL); resources expose the audit log and permission
config; a prompt template generates security reviews.
...
def write_file(filepath: str, content: str) -> str:
    ...
    This operation modifies data and should require user confirmation
    via elicitation.
...
def delete_file(filepath: str) -> str:
    ...
    This operation is destructive and should require detailed user
...
def execute_command(command: str) -> str:
    ...
    This operation can affect system state and should require extensive
    user confirmation. For security, this is a simulation only.
